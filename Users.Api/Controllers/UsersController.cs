...
namespace Users.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPatch]
        public async Task<ActionResult> Save([FromBody]UsuarioDto usuarioDto)
        {
            try
            {
                return Ok(await _userService.Save(usuarioDto));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async Task<ActionResult> Login([FromBody] UsuarioDto usuarioDto)
        {
            try
            {
                return Ok(await _userService.Login(usuarioDto));
            }
            catch (Exception ex)
            {
                throw ex;
